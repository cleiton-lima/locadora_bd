...
use App\Http\Requests\GerenteComercial\StoreGerenteComercialRequest;
use App\Http\Requests\GerenteComercial\UpdateGerenteComercialRequest;
use App\Services\GerenteComercialService;

class GerenteComercialController extends Controller
{
    public function __construct(private readonly GerenteComercialService $service)
    {
    }
    ...
    public function store(StoreGerenteComercialRequest $request)
    {
    ...
    public function update(UpdateGerenteComercialRequest $request, int $id)
    {
